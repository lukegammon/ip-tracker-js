Relitively straightforward as far as responsive design. 
As usual when i code these projects i started mobile first.

HTML structure will be minimal. Just a few sections.
CSS should also be relitively small as just 100vh and 100vw of content needed.
JavaScript will only have a few functions. Also pretty minimal
